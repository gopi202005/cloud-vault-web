...
const Button = React.forwardRef(({
    ...
    const handleClick = (e) => {
        console.log('Button clicked:', { disabled, loading, type, onClick });
        
        // Prevent default behavior for button elements to avoid form submission
        if (type === 'button') {
            e.preventDefault();
        }
        ...
        // Call the onClick handler if provided and not disabled
